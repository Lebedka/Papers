...
%%% *** %%% \def\infix#1#2#3%
%%% *** %%% {\ifinnerabs%
%%% *** %%% (\innerapptrue\innerabstrue #2 #1 \innerapptrue\innerabstrue #3)%
%%% *** %%% \else%
%%% *** %%% \innerapptrue\innerabstrue #2 #1 \innerapptrue\innerabstrue #3%
%%% *** %%% \fi\innerappfalse\innerabsfalse}
%%% *** %%% 
...
%%% *** %%% \def\dconj#1#2%
%%% *** %%% {\ifconj%
%%% *** %%% \innerabsfalse\infix{\dynand}{\conjtrue #1\conjfalse}{\conjtrue #2\conjfalse}%
%%% *** %%% \else
%%% *** %%% \infix{\dynand}{\conjtrue #1\conjfalse}{\conjtrue #2\conjfalse}%
%%% *** %%% \fi}
%%% *** %%% 
%%% *** %%% 
%%% *** %%% \def\ddisj#1#2%
%%% *** %%% {\ifdisj%
%%% *** %%% \innerabsfalse\infix{\dynor}{\disjtrue #1\disjfalse}{\disjtrue #2\disjfalse}%
%%% *** %%% \else
%%% *** %%% \infix{\dynor}{\disjtrue #1\disjfalse}{\disjtrue #2\disjfalse}%
%%% *** %%% \fi}
...
\newcommand{\existsB}{\Sigma} 
\newcommand{\existsC}{\Xi}  

\newcommand{\forallA}{\exists}
\newcommand{\forallB}{\Pi}  
\newcommand{\forallC}{\amalg}  

\newcommand{\impA}{\rightarrow}
\newcommand{\impB}{\Rightarrow}
\newcommand{\impC}{\Rrightarrow}
...
\newcommand{\landB}{\curlywedge}
\newcommand{\landC}{\curlywedgeuparrow}

\newcommand{\lorA}{\lor}
\newcommand{\lorB}{\curlyvee} 
\newcommand{\lorC}{\curlyveedownarrow}
